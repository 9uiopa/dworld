...
public class ArticleApiController {
    ...
    public List<Article> searchArticles(@RequestParam String keyword) throws IOException {
        SearchResponse<Article> searchResponse = elasticSearchService.matchArticlesWithKeyword(keyword);
        List<Hit<Article>> listOfHits = searchResponse.hits().hits(); // hit : 검색 결과
